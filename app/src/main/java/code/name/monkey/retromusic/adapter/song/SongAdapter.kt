...
open class SongAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if ((PreferenceUtil.songGridSize > 2 && !landscape) || (PreferenceUtil.songGridSizeLand > 5 && landscape)) {
            holder.menu?.isVisible = false
             ...
             holder.menu?.isVisible = !isChecked
        }
    }
    ...
    override fun getPopupText(position: Int): String {
        ...
        val sectionName: String? = when (PreferenceUtil.songSortOrder) {
            SortOrder.SongSortOrder.SONG_DEFAULT -> return MusicUtil.getSectionName(song.title, true)
            ...
            SortOrder.SongSortOrder.SONG_YEAR -> return MusicUtil.getYearString(song.year)
        ...
        init {
            menu?.setOnClickListener(object : SongMenuHelper.OnClickSongMenu(activity) {
                ...
                override val menuRes: Int
                    get() = this@ViewHolder.songMenuRes

                override fun onMenuItemClick(item: MenuItem): Boolean {
                    return this@ViewHolder.onSongMenuItemClick(item) || super.onMenuItemClick(item)
                }
            })
        }
